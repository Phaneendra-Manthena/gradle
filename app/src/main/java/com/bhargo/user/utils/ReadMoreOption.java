...
public class ReadMoreOption {
    ...
    private int lessLabelColorBlack;
    ...
    private ReadMoreOption(Builder builder){
        ...
        this.lessLabelColorBlack = builder.lessLabelColorBlack;
    ...
    private void addReadLess(final TextView textView, final CharSequence text) {
        ...
        ClickableSpan clickableSpan = new ClickableSpan() {
            ...
            public void updateDrawState(TextPaint ds) {
                super.updateDrawState(ds);
                ds.setUnderlineText(labelUnderLine);
                ds.setColor(lessLabelColorBlack);
            }
        };
    ...
    public static class Builder {
        ...
        private int moreLabelColor = Color.parseColor("#d35400");
        private int lessLabelColor =  Color.parseColor("#d35400");
        private int lessLabelColorBlack =  Color.parseColor("#000000");
