...
public class RoundishImageViewTopLeftRight extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public RoundishImageViewTopLeftRight(Context context) {
        this(context, null);
    }

    public RoundishImageViewTopLeftRight(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundishImageViewTopLeftRight(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RoundishImageViewTopLeftRight);
        cornerRadius = a.getDimensionPixelSize(R.styleable.RoundishImageViewTopLeftRight_cornerRadiusTopLeftRight, 0);
        roundedCorners = a.getInt(R.styleable.RoundishImageViewTopLeftRight_roundedCornersTopLeftRight, CORNER_NONE);
        a.recycle();
    }
