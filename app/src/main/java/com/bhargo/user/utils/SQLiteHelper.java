...
public class SQLiteHelper extends SQLiteOpenHelper {
   ...
   /* @Override
     ...
     * @return
     */
    public List<List<String>> getTblDataNullStatus(String TableName,
                                                   String wherecolnames[], String wherecolumnValue[]) {
        SQLiteDatabase db = this.getReadableDatabase();
        String query = "SELECT * FROM " + TableName + " WHERE ";
        for (int k = 0; k < wherecolnames.length; k++)
...
//        query = query.substring(0, query.length() - 5);
    ...
    public List<List<String>> getTableColDataByNotCond(String TableName,
                                                    String outColNamesByComma, String wherecolnames[],
                                                    String wherecolumnValue[]) {
        SQLiteDatabase db = this.getReadableDatabase();
        String query = "SELECT " + outColNamesByComma + " FROM " + TableName
    ...
    public List<List<String>> getTableSrchRegDataByCond(String TableName,
                                                    String outColNamesByComma, String wherecolnames[],
                                                    String wherecolumnValue[],String notColum1 ,String notvalue1 ) {
        ...
        for (int k = 0; k < wherecolnames.length; k++)
            query = query + wherecolnames[k] + "='" + wherecolumnValue[k] + "'"
                    + " AND ";
//        query = query.substring(0, query.length() - 5);
        query =query +notColum1 + "!='" + notvalue1+"'";
    ...
    public List<List<String>> getTableColDataByCondnoteqals(String TableName,
                                                            String outColNamesByComma, String wherecolnames,
                                                            String wherecolumnValue, String notEqualsColumnNme, String notEqualsColumnValue, String name_key) {
        SQLiteDatabase db = this.getReadableDatabase();
        String query = "SELECT " + outColNamesByComma + " FROM " + TableName
                + " WHERE " + wherecolnames + "='" + wherecolumnValue + "'"
                + " AND " + notEqualsColumnNme + " IS NOT '" + notEqualsColumnValue + "'" + " AND " + name_key + " IS NOT " + null;
//        query = query.substring(0, query.length() - 5);
        // //System.out.println("Final Query:" + query);
        Cursor cur = db.rawQuery(query, null);
        List<List<String>> list = new ArrayList<List<String>>();
    ...
    public List<List<String>> getTableDataByDailyAttendence (String TableName,
                                                            String outColNamesByComma, String wherecolname1,
                                                            String wherecolval1,String wherecolname2,String wherecolval2, String notEqualsColumnNme, String notEqualsColumnValue, String notEqualsColumnNme2, String notEqualsColumnValue2, String column_notnull) {

        SQLiteDatabase db = this.getReadableDatabase();
        String query = "SELECT " + outColNamesByComma + " FROM " + TableName
                + " WHERE " + wherecolname1 + "='" + wherecolval1 + "'"
                + " AND " + wherecolname2 + "='" + wherecolval2 + "'" + " AND "+ notEqualsColumnNme + " IS NOT '" + notEqualsColumnValue + "'" + " AND "+ notEqualsColumnNme2 + " IS NOT '" + notEqualsColumnValue2 + "'" +" AND " + column_notnull + " IS NOT " + null;
//        query = query.substring(0, query.length() - 5);
        // //System.out.println("Final Query:" + query);
        Cursor cur = db.rawQuery(query, null);
        List<List<String>> list = new ArrayList<List<String>>();
     ...
     * @return
     */
    public List<List<String>> getTableColDataByNotValueAndEqulValue(String TableName,
                                                                    String columnNamesByComma, String notcolumname,
                                                                    String notcolumnValue,String equalcolumn1,String EqualValue1,String equalcolumn2,String EqualValue2,String notcol2,String noyal2) {

        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cur = db.rawQuery("SELECT " + columnNamesByComma + " FROM "
                + TableName + " WHERE " + notcolumname + "<>'" + notcolumnValue+ " AND"+ " WHERE " + equalcolumn2 + "<>'" + EqualValue2+ " AND"+ " WHERE " + equalcolumn1 + "='" + EqualValue1+ " AND"+ " WHERE " + equalcolumn2 + "<>'" + EqualValue2
                + "'", null);
        List<List<String>> list = new ArrayList<List<String>>();
        if (cur.getCount() > 0)
            list = cursorToListArr(cur);
    ...
    public List<List<String>> getTableColDataByEqualANDNotCond(String TableName,
                                                       String outColNamesByComma, String condcolnames[],
                                                       String condcolValue[],String notCondcolnames[],String notCondcolValues[]) {
        SQLiteDatabase db = this.getReadableDatabase();
        String query = "SELECT " + outColNamesByComma + " FROM " + TableName
                + " WHERE ";
        for (int k = 0; k < condcolnames.length; k++)
        ...
        for (int l = 0; l < notCondcolnames.length; l++)
            query = query + notCondcolnames[l] + "!='" + notCondcolValues[l] + "'"
                    + " AND ";
    ...
    public boolean updateRowEqAndnotData(Context context,
                                 final String tablename, String[] columnNames,
                                 String[] columnValues, String[] whereColumn, String[] whereValue,String[] whereNotColumn,String[] whereNotColumnVal) {
        ...
        if (whereColumn != null) {
            ...
            if (whereColumn != null) {
                for (int k = 0; k < whereNotColumn.length; k++) {
                    whereClause = whereClause + whereNotColumn[k] + "!='"
                            + whereNotColumnVal[k] + "'" + " AND ";
                }
            }
                whereClause = whereClause.substring(0, whereClause.length() - 5);
            System.out.println("whereclause......" + whereClause);
