...
class ItemMessageUserHolder extends RecyclerView.ViewHolder {
    ...
    public ItemMessageUserHolder(View itemView) {
        ...
        layout_message.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
//                iClickListener.onItemClickedItem(getAdapterPosition());
                return false;
            }
        });
    ...
    void setIClickListener(ItemMessageUserHolder.IClickListener iClickListener) {
