...
public class SearchableListDialog extends DialogFragment implements
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		// Getting the layout_sample_app inflater to inflate the view in an alert dialog.
		LayoutInflater inflater = LayoutInflater.from(getActivity());
		if (null != savedInstanceState) {
			_searchableItem = (SearchableItem) savedInstanceState
		...
		String strPositiveButton = _strPositiveButtonText == null ? "CLOSE"
...
//		wmlp.y = 210;
	...
	private void setData(View rootView) {
		...
		// THIS IS TO REMOVE SEARCH ICON
		int magId = getResources().getIdentifier("android:id/search_mag_icon",
				null, null);
		ImageView magImage = (ImageView) _searchView.findViewById(magId);
		...
		_listViewItems
				.setOnItemClickListener(new AdapterView.OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
						...
						_searchableItem.onSearchableItemClicked(
								listAdapter.getItem(position), position);
						getDialog().dismiss();
					}
				});
	}
