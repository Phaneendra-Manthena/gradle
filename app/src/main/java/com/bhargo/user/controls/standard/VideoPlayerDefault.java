...
public class VideoPlayerDefault implements PathVariables, UIVariables {
    ...
    public LinearLayout linearLayout, ll_displayName, ll_v_one, ll_v_two;
    ...
    public VideoPlayerDefault(Context context, ControlObject controlObject, boolean SubformFlag, int SubformPos, String SubformName) {
...
//            iv_fullScreen = view.findViewById(R.id.iv_fullScreen);
            ll_v_one = view.findViewById(R.id.ll_v_one);
            ll_v_two = view.findViewById(R.id.ll_v_two);
          ...
          /*  iv_fullScreen.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (isStretch) {
                        ...
                        ll_videoPlayer_main.setLayoutParams(layoutParams);
                        ll_v_one.setLayoutParams(layoutParams);
                        ViewGroup.LayoutParams paramsl = ll_v_two.getLayoutParams();
                        ViewGroup.LayoutParams params = fl_video.getLayoutParams();
                        paramsl.width = -1;
                        paramsl.height = VIDEO_STRETCH_SCREEN_HEIGHT;
                        params.width = -1;
                        params.height = VIDEO_STRETCH_SCREEN_HEIGHT;
                        Log.d(TAG, "VIDEO_STRETCH_SCREEN_HEIGHT: " + VIDEO_STRETCH_SCREEN_HEIGHT);
                        ll_v_two.setLayoutParams(paramsl);
                        fl_video.setLayoutParams(params);
                    } else {
                        isStretch = true;
                        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-1, improveHelper.dpToPx(250));
                        LinearLayout.LayoutParams layoutParams_one = new LinearLayout.LayoutParams(-1, -2);
                        ll_videoPlayer_main.setLayoutParams(layoutParams);
                        ll_v_one.setLayoutParams(layoutParams_one);
                        ViewGroup.LayoutParams paramsl = ll_v_two.getLayoutParams();
                        ViewGroup.LayoutParams params = fl_video.getLayoutParams();
                        int h = VIDEO_STRETCH_SCREEN_HEIGHT;
                        paramsl.width = -1;
                        paramsl.height = -1;
                        params.width = -1;
                        params.height = improveHelper.dpToPx(200);
                        ll_v_two.setLayoutParams(paramsl);
                        fl_video.setLayoutParams(params);
