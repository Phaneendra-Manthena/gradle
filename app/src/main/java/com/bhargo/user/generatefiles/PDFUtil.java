...
//    public static final double PDF_PAGE_HEIGHT_INCH = 11.7;
     ...
     */
    public final void generatePDF(final Activity context,final List<View> contentViews, final String filePath,
        ...
        private void writePDFDocument(final PdfDocument pdfDocument) {
            ...
            for (int i = 0; i < mContentViews.size(); i++) {
                ...
                PdfDocument.PageInfo pageInfo = new PdfDocument.PageInfo.
                        Builder((int) contentView.getWidth(), (int) contentView.getHeight(), i + 1).create();
